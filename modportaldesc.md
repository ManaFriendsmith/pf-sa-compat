...
# Fulgora wall-related concussion prevention #

Depending on the number of BZ and Planetfall material mods installed and the difficulty setting, Fulgoran islands will be scaled up. This is to allow a single moderate-to-big island to allow decent and sustainable-without-manual-intervention midgame production of science, intermediates and buildings, without having to fully bot everything or be a Spatial Packing Wizard.

This can be disabled in the mod settings.

# Postgame Logistics Tier #

Adds an extra tier of belts and cargo wagons that can almost keep up with the absurd output of legendary buildings.
